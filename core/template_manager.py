        ...
        return {
            'base_theme': {
                ...
                'styles': {
                    ...
                    'p': 'font-size: 16px; color: #555; line-height: 1.8; margin-bottom: 15px; text-align: justify;padding: 0 10px;',
            ...
            'tech_blue': {
                ...
                'styles': {
                    ...
                    'p': 'font-size: 16px; color: #000000; line-height: 1.8; margin-bottom: 15px; text-align: justify;padding: 0 10px;',
            ...
            'warm_orange': {
                ...
                'styles': {
                    ...
                    'p': 'font-size: 16px; color: #5d4037; line-height: 1.8; margin-bottom: 16px; text-align: justify; padding: 0 10px;',
            ...
            'business_gray': {
                ...
                'styles': {
                    ...
                    'p': 'font-size: 16px; color: #2c3e50; line-height: 1.8; margin-bottom: 18px; text-align: justify;padding: 0 10px;',
            ...
            'entertainment_pink': {
                ...
                'styles': {
                    ...
                    'p': 'font-size: 16px; color: #6f2c91; line-height: 1.8; margin-bottom: 16px; text-align: justify;padding: 0 10px;',
            ...
            'nature_green': {
                ...
                'styles': {
                    ...
                    'p': 'font-size: 16px; color: #2e7d32; line-height: 1.8; margin-bottom: 16px; text-align: justify;padding: 0 10px;',
            ...
            'numbered_sequence': {
                ...
                'styles': {
                    ...
                    'p': 'font-size: 16px; color: #2c3e50; line-height: 1.8; margin-bottom: 18px; text-align: justify; background: rgba(255, 255, 255, 0.6); padding: 10px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.1);',
